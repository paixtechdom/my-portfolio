    ...
    return(
        <div className="fixed h-screen w-full bg-black bg-opacity-90 center" style={{
            ...
            >
                ...
                <h3 className='text-center font-bold text-gray-200 text-3xl'>{alertMessage}</h3>

                <button className='bg-dark bg-gray-900 border w-4/12 px-7 border-gray-100 rounded-xl p-2 mt-6' 
